...
class QAgent(Agent):
    def __init__(self):
        ...
        self.current_state_grid = np.zeros([4,10],'int8')
        self.next_state_grid = np.zeros([4,10],'int8')
    ...
    def initialise(self, grid):
        ...
        self.current_state_grid = grid[:4]
    ...
    def learn(self):
        ...
        # print ('current reward is {0}').format(self.current_reward)
    ...
    def callback(self, learn, episode, iteration):
        ...
        with open('q_result_4.csv','a') as f_handle:
